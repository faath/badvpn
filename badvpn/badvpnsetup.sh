...
echo "na porta 7300, usado por programas como Atlantus VPN 2.0 ou outros APPs."
...
if [[ "$resposta" = 's' ]]; then
	...
	rm -r badvpn-build
	echo "#!/bin/bash
	badvpn-udpgw --listen-addr 127.0.0.1:7300 --max-clients 10000 --max-connections-for-client 5" > /bin/badudp
	chmod +x /bin/badudp
	clear
	tput setaf 3 ; tput bold ; echo ""
	echo ""
